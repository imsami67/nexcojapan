...
<!-- start page content -->
                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Vehicle Expense Files</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Vehicle Expense Files</li>
			...
			<div class="col-sm-12">
				...
				<div class="panel">
					...
					<div class="panel-heading panel-heading-red" align="center"><h4>Create Vehicle Expense Files</h4></div>
							...
							<form action="php_action/custom_action.php" method="POST" role="form" id="formData">
								...
								<div class="form-group row">
									...
									<div class="col-sm-5">
										...
										<input type="text" class="form-control d-none" id="file_type" name="file_type" value= "expense_document"> 
		...
		<form method="post" action="" name="login" enctype="multipart/form-data">
			...
			<tbody>
				...
				<?php  
					...
					$q = get($dbc,"airmail_files WHERE file_type = 'expense_document' AND vehicle_id = '$id'");
