...
<div class="panel">
	<div class="panel-heading panel-heading-purple" align="center"><h4>Sale Report</h4></div>
	<div class="panel-body">
		...
		<?php if(isset($_REQUEST['search_sale'])): 
			...
			?>
					...
					<button onclick="window.print();"  class="btn btn-primary pull-right print_btn print_hide">Print Report</button><br><br>
		<table class="table table-bordered">
			...
			<tbody>
				<?php $i=1; 
				$q = mysqli_query($dbc,"SELECT * FROM orders WHERE (order_date BETWEEN '$f_date' AND '$t_date') OR client_name='$customer_id'"); ?>
