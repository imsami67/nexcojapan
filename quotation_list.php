	           ...
	           <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Quotation List</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Quatation List</li>
...
<?php $c=0; $getQuation=mysqli_query($dbc,"SELECT * FROM  invoice WHERE invoice_quotation='quotation'");
 ...
 ?>
		...
		<tr><td><?=$c?></td>
			...
			<td>
				...
				<a href="quotation_form.php?edit_quotation_id=<?=$fetchQuation['invoice_id']?>" class="btn-sm btn-success">Edit</a> |
				<?php endif ?>
				<a href="print_invoice.php?invoice_id=<?=$fetchQuation['invoice_id']?>&transaction_id=quotation" class="btn-sm btn-primary"><i class="fa fa-print mr-1"></i>Print</a> |

<!-- 				<a href="services_form.php?invoice=<?=base64_encode($fetchQuation['invoice_id'])?>&transaction_id=quotation" class="btn-sm btn-info "><i class="fa fa-plus mr-1"></i>Services</a>

				<a href="quotation_form.php?edit_quotation_id=<?=$fetchQuation['invoice_id']?>&act=make_invoice" class="btn-sm btn-primary "><i class="fa fa-plus mr-1"></i>Make Invoice</a>
 -->
